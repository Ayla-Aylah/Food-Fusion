    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:justify-between md:items-start space-y-8 md:space-y-0">
            ...
            <nav
                ...
                <a href="/foodfusion/admin/userList"
                    class="hover:underline hover:text-[#bef264] 0 text-sm transition duration-300 focus:outline-none focus:ring-2 focus:ring-white rounded">User
                    List</a>
                <a href="/foodfusion/admin/recipes"
                ...
                <a href="/foodfusion/admin/messages"
                    class="hover:underline focus:outline-none hover:text-[#bef264]  text-sm  transition duration-300 focus:ring-2 focus:ring-white rounded">Messages</a>
            </nav>
            ...
            <div
                ...
                <a href="/foodfusion/admin/privacy"
                    class="mt-10 hover:text-[#bef264] text-sm  transition duration-300 hover:underline focus:outline-none focus:ring-2 focus:ring-white rounded">Privacy
                    Policy</a>
                <a href="/foodfusion/admin/terms"
                    ...
                    of Service</a>
                <a href="/foodfusion/admin/cookie"
